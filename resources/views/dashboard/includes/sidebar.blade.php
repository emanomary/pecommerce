        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item ">
                ...
                <ul class="menu-content">
                    <li class="">
                        <a class="menu-item" href="{{--route('admin.languages.index')--}}" data-i18n="nav.dash.ecommerce">
                            {{__('messages.showAll')}}
                        </a>
                    </li>
                    <li>
                        <a class="menu-item" href="{{--route('admin.languages.create')--}}" data-i18n="nav.dash.crypto">
            ...
            <li class="nav-item">
                ...
                <ul class="menu-content">
                    <li class="">
                        <a class="menu-item" data-i18n="nav.dash.ecommerce" href="{{route('maincategories.index')}}">
                            {{__('messages.showAll')}}
                        </a>
                    </li>
                    <li>
           ...
           {{-- <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <ul class="menu-content">
                    <li class="">
                        <a class="menu-item" href="{{--route('admin.vendors.index')--}}" data-i18n="nav.dash.ecommerce">
                            {{__('messages.showAll')}}
                        </a>
                    </li>
                    <li>
                        <a class="menu-item" href="{{--route('admin.vendors.create')--}}" data-i18n="nav.dash.crypto">
                ...
                <ul class="menu-content">
                    <li>
                        <a class="menu-item" href="#" data-i18n="nav.templates.vert.main">
                            {{__('messages.deliveryMethods')}}
                        </a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('edit.shipping','free')}}" data-i18n="nav.templates.vert.classic_menu">
                                    {{__('messages.freeDelivery')}}
                                </a>
                            </li>
                            <li>
                                <a class="menu-item" href="{{route('edit.shipping','internal')}}">
                                    {{__('messages.internalDelivery')}}
                                </a>
                            </li>
                            <li><a class="menu-item" href="{{route('edit.shipping','external')}}" data-i18n="nav.templates.vert.compact_menu">
                                    {{__('messages.externalDelivery')}}
                                </a>
                            </li>
                        </ul>
                    </li>
